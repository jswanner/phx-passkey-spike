defmodule Handroll.Accounts.Account do
  use Ecto.Schema
  ...
  defp validate_email(changeset, opts) do
    ...
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, Handroll.Repo)
  ...
  """
  def valid_password?(%Handroll.Accounts.Account{hashed_password: hashed_password}, password)
