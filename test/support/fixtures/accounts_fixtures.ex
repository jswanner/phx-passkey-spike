defmodule Handroll.AccountsFixtures do
  @moduledoc """
  This module defines test helpers for creating
  entities via the `Handroll.Accounts` context.
  """
  ...
  def account_fixture(attrs \\ %{}) do
    ...
    {:ok, account, _expired_tokens} = Accounts.login_account_by_magic_link(token)
  ...
  def generate_account_magic_link_token(account) do
    ...
    Handroll.Repo.insert!(account_token)
